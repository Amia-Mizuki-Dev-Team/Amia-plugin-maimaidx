...
if maiconfig.lxnspath:
    ...
    log.warning("未在 .env 中成功解析到路径配置，系统将默认挂载至当前运行目录下的 static 文件夹。")

static: Path = Path(determined_path)

# 核心游戏资源骨架总线
maidir: Path = static / 'mai' / 'pic'
...
guess_file: Path = static / 'group_guess_switch.json'
...
# ==========================================
__all__ = [
    "Config", "maiconfig", "Root", "static", "maidir", "coverdir", "ratingdir", "platedir",
