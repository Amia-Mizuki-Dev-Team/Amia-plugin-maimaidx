    ...
    try:
        ...
        for num, info in enumerate(diff):
            ...
            if info:
                ...
                tb.draw(685, 248 + y * num - 10, 25, music.ds[num], anchor='mm')
                fit_diff = music.stats[num].fit_diff if music.stats and len(music.stats) > num and music.stats[num] else None
                if fit_diff:
                    tb.draw(685, 248 + y * num + 15, 14, f"拟:{fit_diff:.2f}", (120, 130, 160, 255), anchor='mm')
